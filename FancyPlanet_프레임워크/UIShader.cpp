...
void NumberShader::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	std::chrono::seconds ms = std::chrono::duration_cast<std::chrono::seconds>(chrono::system_clock::now() - start);

	m_ui.xmf4Number = CalculateNumberTexture((ms.count()) % 10);
